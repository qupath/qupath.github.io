...
qupath_release_notes: https://github.com/qupath/qupath/releases/tag/v0.7.0
qupath_release_latest: https://github.com/qupath/qupath/releases/latest
qupath_download_msi: https://github.com/qupath/qupath/releases/download/v0.7.0/QuPath-v0.7.0-Windows.msi
qupath_download_zip: https://github.com/qupath/qupath/releases/download/v0.7.0/QuPath-v0.7.0-Windows.zip
qupath_download_pkg: https://github.com/qupath/qupath/releases/download/v0.7.0/QuPath-v0.7.0-Mac-x64.pkg
qupath_download_pkg_s: https://github.com/qupath/qupath/releases/download/v0.7.0/QuPath-v0.7.0-Mac-arm64.pkg
qupath_download_tar: https://github.com/qupath/qupath/releases/download/v0.7.0/QuPath-v0.7.0-Linux.tar.xz
...
#Banner
banner: <a href="https://github.com/qupath/qupath/releases/tag/v0.7.0" target=blank>0.7.0 is now available!</a>
...
download_dropdown_msi_aria: follow this link to download qupath for windows m s i 271 M B
download_dropdown_zip_aria: follow this link to download qupath for windows Z I P 270 M B
download_dropdown_mac_aria: Choose which mac version to download
download_dropdown_pkg_aria: follow this link to download qupath for macOS intel p k g 241 M B
download_dropdown_pkg_s_aria: follow this link to download qupath for macOS apple silicon p k g 230 M B
download_dropdown_which_aria: Follow this link to learn more about which mac version to download
download_dropdown_tar_aria: follow this link to download qupath for Linux t a r 244 M B
...
latest_release_notes: Release notes v0.7.0
